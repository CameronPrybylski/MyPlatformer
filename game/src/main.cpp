...
int main()
{
    ...
    if(!app.Create("Game", 1067, 800)){
        ...
        std::shared_ptr<Scene> level2 = std::make_shared<Level>(app.GetScreenWidth(), app.GetScreenHeight(), "/Users/cameronprzybylski/Documents/C++/C++ Projects/MyPlatformer/levels/level2.json");
